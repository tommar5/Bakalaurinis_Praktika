...
export class RoomAndTravelersCount extends Component {
  state = {
  ...
  render() {
    ...
    const {adultsCount, childrenCount,  roomsCount, AllTravelersCount} = this.props;
    const { handleAdd, handleSubstract } = this.props;
                ...
                >
                    <Grid item xs={12} className={classes.travelerRow}>
                        ...
                        {adultsCount == 1 ? (
                            ...
                            <Button id="adultsCount" variant="contained" color="primary" className={classes.addRemoveButton} onClick={handleSubstract}><RemoveIcon /></Button>
                        )}
                        {adultsCount}
                        {adultsCount == 9 ? (
                            <Button id="adultsCount" disabled variant="contained" color="primary" className={classes.addRemoveButton} onClick={handleAdd}><AddIcon /></Button>
                        ) : (
                            <Button id="adultsCount" variant="contained" color="primary" className={classes.addRemoveButton} onClick={handleAdd}><AddIcon /></Button>
                        )}
                    </Grid>
                    <Grid item xs={12} className={classes.travelerRow}>
                        ...
                        {childrenCount == 0 ? (
                            ...
                            <Button id="childrenCount" variant="contained" color="primary" className={classes.addRemoveButton} onClick={handleSubstract}><RemoveIcon /></Button>
                        )}
                        {childrenCount}
                        {childrenCount == 9 ? (
                            <Button id="childrenCount" disabled variant="contained" color="primary" className={classes.addRemoveButton} onClick={handleAdd}><AddIcon /></Button>
                        ) : (
                            <Button id="childrenCount" variant="contained" color="primary" className={classes.addRemoveButton} onClick={handleAdd}><AddIcon /></Button>
                        )}
                    </Grid>
                    <Grid item xs={12} className={classes.travelerRow}>
                        <div style={{width:120, display: 'inline-block'}}>
                        ...
                        {roomsCount == 0 ? (
                            ...
                            <Button id="inflantsCount" variant="contained" color="primary" className={classes.addRemoveButton} onClick={handleSubstract}><RemoveIcon /></Button>
                        )}
                        {roomsCount}
                        {roomsCount == 9 ? (
                            <Button id="inflantsCount" disabled variant="contained" color="primary" className={classes.addRemoveButton} onClick={handleAdd}><AddIcon /></Button>
                        ) : (
                            <Button id="inflantsCount" variant="contained" color="primary" className={classes.addRemoveButton} onClick={handleAdd}><AddIcon /></Button>
                        )}
                    </Grid>
                    {error ? (
...
RoomAndTravelersCount.propTypes = {
  classes: PropTypes.object.isRequired
}

export default withStyles(styles)(RoomAndTravelersCount)
